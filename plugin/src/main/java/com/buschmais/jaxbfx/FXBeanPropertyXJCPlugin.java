...
public class FXBeanPropertyXJCPlugin extends Plugin {
                ...
                for (FieldOutline fieldOutline : declaredFields) {
                    ...
                    if (field != null) {
                        ...
                        if (JAVA_LANG_STRING.equals(qualifiedFieldTypeName)) {
                            ...
                            createFXEnabledPropertyAccess(booleanType, booleanPropertyType, simpleBooleanPropertyType, propertyInfo, implClass, codeModel, IS_GETTER_PREFIX, false, true);
                            ...
                            createFXEnabledPropertyAccess(doubleType, doublePropertyType, simpleDoublePropertyType, propertyInfo, implClass, codeModel, GETTER_PREFIX, false, true);
                            ...
                            createFXEnabledPropertyAccess(floatType, floatPropertyType, simpleFloatPropertyType, propertyInfo, implClass, codeModel, GETTER_PREFIX, false, true);
                            ...
                            createFXEnabledPropertyAccess(integerType, integerPropertyType, simpleIntegerPropertyType, propertyInfo, implClass, codeModel, GETTER_PREFIX, false, true);
                            ...
                            createFXEnabledPropertyAccess(longType, longPropertyType, simpleLongPropertyType, propertyInfo, implClass, codeModel, GETTER_PREFIX, false, true);
    ...
    private void createFXEnabledListPropertyAccess(JType plainType, JType propertyType, JType simplePropertyType, CPropertyInfo propertyInfo, JDefinedClass implClass, JCodeModel codeModel) throws ClassNotFoundException {
        ...
        ifProxyBlock._then().assign( JExpr._this().ref(nFieldVar), JExpr._new(narrowedSimplePropertyType)
                .arg(jxCollectionsType.staticInvoke("observableArrayList")
                        .arg(collectionField)));
        ...
        JFieldVar oFieldVar = implClass.fields().get(oPrivateFieldName);
        JInvocation getOnProxyInvocation = JExpr._this().ref(nFieldVar).invoke("get");
